            ...
            return (
              ...
              >
                ...
                {isSidebarOpen && showBadge && (
                  <Badge className="ml-auto flex h-5 min-w-5 shrink-0 items-center justify-center rounded-full px-1.5">
        ...
        <header className="h-16 border-b bg-background/50 backdrop-blur-md px-4 flex items-center justify-between z-40">
          <div className="flex items-center gap-4">
            ...
            <form
              ...
              className="hidden sm:flex items-center bg-muted/30 rounded-full px-4 py-2 gap-2 w-64 md:w-96 border focus-within:ring-2 ring-primary/20 transition-all focus-within:bg-background"
            >
